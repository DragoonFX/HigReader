	...
	if(strstr(fname, "onik"))
	{
		...
		else if(!strstr(fname, "tips"))
		{
			if(strstr(fname, "000"))
				...
				title_num = 5;
			else if(strstr(fname, "009") && !strstr(fname, "02"))
				title_num = 6;
				...
				title_num = 11;
			else if(strstr(fname, "014") && !strstr(fname, "02"))
				title_num = 12;
			else if(strstr(fname, "014_02"))
				title_num = 13;
			else if(strstr(fname, "015") && !strstr(fname, "02") && !strstr(fname, "03"))
				title_num = 14;
...
void CharacterValidation(char *currentLine)
{
  ...
  bool hasName = false;
	...
	else if( strstr(currentLine,"DrawBustshot") )
  {
